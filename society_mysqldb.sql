...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2018 at 07:23 PM
...
(1114, 1001, 'A-I Test', '2018-01-02', 'This is a test for auto-increment', 1);
...
--
ALTER TABLE `notices`
  MODIFY `notice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1115;
